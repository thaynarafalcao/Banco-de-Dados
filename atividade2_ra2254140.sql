...
DROP TABLE IF EXISTS CRIADORES_CONTRATAM_FUNC;
DROP TABLE IF EXISTS TRANSP_ENVIA_PARA_CLIENTES;
DROP TABLE IF EXISTS CLIENTES_JOGAM_JOGOS;
DROP TABLE IF EXISTS FUNC_DESENVOLVEM_JOGOS;
DROP TABLE IF EXISTS FUNC_TRABALHAM_EM_SUP;
